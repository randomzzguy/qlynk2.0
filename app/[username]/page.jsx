    ...
    return (
      <div className="min-h-screen bg-[#0f0f14] flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-4xl font-black text-white mb-4 tracking-tight">Qlynk Agent Offline</h1>
          <p className="text-lg text-gray-400 mb-10 leading-relaxed">This Qlynk Agent is currently in maintenance.</p>
