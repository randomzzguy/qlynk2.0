...
const rows = [
  ...
  ['Current entry pricing', 'Creator is $18 monthly or $168 annually. Agency is $38 monthly or $360 annually. The 14-day trial includes everything in Agency, and each account has one agent.', 'Free plan plus paid Hobby, Standard, Pro, and Enterprise tiers; credits, seats, sources, actions, integrations, and analytics vary by tier.'],
];
      ...
      <main>
        ...
        <section className="mx-auto grid max-w-6xl gap-8 px-6 py-20 md:grid-cols-[1fr_.8fr]">
          <div>
            ...
            <p className="mt-5 leading-relaxed text-gray-400">Qlynk details, including current paid-plan pricing, were checked against the current application, plan configuration, and product pages on August 31, 2026. Chatbase details were checked against its official documentation and pricing page on July 21, 2026. We avoided scoring features that cannot be compared fairly and did not treat a missing mention as proof that a feature does not exist.</p>
