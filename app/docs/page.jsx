...
const groups = [
  ...
  { icon: Eye, title: 'Test and improve', description: 'Test expected, uncertain, sensitive, and out-of-scope questions, then review real knowledge gaps.', links: [['How the agent understands context', '/blog/qlynk-agent-understands-questions-better'], ['Analytics and review', '/features/analytics'], ['AI knowledge management', '/blog/ai-knowledge-management']] },
  { icon: BookOpen, title: 'Publish and share', description: 'Use the hosted Qlynk link or add the agent to a website, then keep ownership and sources current.', links: [['Embed the agent on a website', '/blog/embed-ai-agent-on-website'], ['Change your public username', '/blog/how-to-change-qlynk-username'], ['Sharing and embed features', '/features/integrations']] },
];
