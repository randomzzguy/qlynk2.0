...
export function buildAgentSystemPrompt(config, documents = []) {
  ...
  parts.push('6. FORMATTING: ALWAYS use highly structured markdown. Break down your responses into easily scannable sections using clear headings (###), bullet points, and **bold text** for emphasis. Use relevant emojis strategically to add personality. NEVER output a single large block of text.');
