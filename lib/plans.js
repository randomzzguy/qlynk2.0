export const PLAN_LIMITS = {
  // The free trial mirrors the Agency plan for 14 days.
  trial: 10000,
  creator: 5000,
  pro: 5000,
  agency: 10000,
...
export const AGENCY_FEATURE_TIERS = ['trial', 'agency', 'business'];
...
export function hasAgencyFeatures(tier) {
  return AGENCY_FEATURE_TIERS.includes(normalizeTier(tier));
}
