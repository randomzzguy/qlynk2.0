...
const CURRENT_USER_CACHE_MS = 5 * 60 * 1000

// Lightweight client-side wrappers for common Supabase operations
export const getCurrentUser = async () => {
  if (currentUserPromise && Date.now() - currentUserCachedAt < CURRENT_USER_CACHE_MS) {
...
export const getCurrentProfile = async (currentUser = null) => {
  try {
    const supabase = createClientBrowser()
